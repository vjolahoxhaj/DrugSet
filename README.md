...
The `packages.R` script installs and loads the required packages automatically.
...
Open `torun.R` in RStudio and run:
...
![DOI Zenodo](https://img.shields.io/badge/Zenodo DOI-10.5281/zenodo.21257373-green)
